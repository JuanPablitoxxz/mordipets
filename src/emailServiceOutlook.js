...
// Configuración del transporter de email con Outlook
const createTransporter = () => {
  return nodemailer.createTransporter({
    ...
    secure: false,
    auth: {
      user: process.env.EMAIL_USER || 'mordipetss@outlook.com',
...
const sendVerificationCode = async (email, code) => {
  try {
    ...
    if (!process.env.EMAIL_USER || !process.env.EMAIL_PASS) {
      ...
      console.error('   EMAIL_USER = mordipetss@outlook.com');
      console.error('   EMAIL_PASS = tu-contraseña-de-outlook');
      return { 
        success: false, 
    ...
    console.log('🔌 Verificando conexión con Outlook...');
    await transporter.verify();
    console.log('✅ Conexión con Outlook verificada');
